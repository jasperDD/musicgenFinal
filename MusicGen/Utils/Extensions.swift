...
extension UIColor {
    ...
    static let purpleApp = UIColor.rgb(red: 97, green: 62, blue: 234)
    static let grayApp = UIColor.rgb(red: 229, green: 229, blue: 229)
    static let bgApp = UIColor.rgb(red: 249, green: 250, blue: 251)
    static let purpleLightApp = UIColor.rgb(red: 194, green: 183, blue: 241)
    static let orangeApp = UIColor.rgb(red: 242, green: 153, blue: 74)
}
...
extension UIView {
    ...
    func addShadow(){
        ...
        layer.shadowOffset = CGSize(width: 1.5, height: 3.5)
